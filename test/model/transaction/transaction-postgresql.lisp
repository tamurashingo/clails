...
(deftest manual-commit-test-postgresql
  (testing "Manual transaction using with-transaction should persist data (PostgreSQL)"
    (cleanup-table)
...
(deftest manual-rollback-test-postgresql
  (testing "Manual transaction with error using with-transaction should discard data (PostgreSQL)"
    (cleanup-table)
