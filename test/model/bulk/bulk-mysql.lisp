(in-package #:cl-user)
(defpackage #:clails-test/model/bulk/bulk-mysql
  (:use #:cl
        #:rove
        #:clails/model)
...
(in-package #:clails-test/model/bulk/bulk-mysql)
    ...
    (loop for i from 1 to count
          do (dbi-cp:execute
              (dbi-cp:prepare connection 
                             "INSERT INTO users2 (name, age, status, created_at, updated_at) VALUES (?, ?, ?, now(), now())")
...
(deftest mysql-test-with-query-cursor-basic
...
(deftest mysql-test-with-query-cursor-small-batch
...
(deftest mysql-test-with-query-cursor-large-batch
...
(deftest mysql-test-with-query-cursor-with-where
...
(deftest mysql-test-with-query-cursor-plist-format
...
(deftest mysql-test-with-query-cursor-empty-result
...
(deftest mysql-test-with-query-cursor-without-transaction
...
(deftest mysql-test-with-query-cursor-with-transaction
...
(deftest mysql-test-with-query-cursor-with-external-connection
...
(deftest mysql-test-with-query-cursor-data-order
...
(deftest mysql-test-with-query-cursor-no-duplicates
...
(deftest mysql-test-show-query-sql-with-query
