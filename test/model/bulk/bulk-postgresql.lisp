(in-package #:cl-user)
(defpackage #:clails-test/model/bulk/bulk-postgresql
  (:use #:cl
        #:rove
        #:clails/model)
...
(defpackage #:clails-test/model/bulk-db
  (:use #:cl)
  (:import-from #:clails/model/migration
                #:defmigration
                #:create-table
...
(in-package #:clails-test/model/bulk/bulk-postgresql)
...
(deftest postgresql-test-with-query-cursor-basic
...
(deftest postgresql-test-with-query-cursor-small-batch
...
(deftest postgresql-test-with-query-cursor-large-batch
...
(deftest postgresql-test-with-query-cursor-with-where
...
(deftest postgresql-test-with-query-cursor-plist-format
...
(deftest postgresql-test-with-query-cursor-empty-result
...
(deftest postgresql-test-with-query-cursor-without-transaction
  (testing "with-query-cursor without explicit transaction (auto-transaction)"
    (cleanup-table)
    (insert-test-data 50)
    ...
    (let ((total-count 0))
      ...
      (ok (= total-count 50) "Should process all records with auto-transaction"))))


(deftest postgresql-test-with-query-cursor-with-transaction
...
(deftest postgresql-test-with-query-cursor-with-external-connection
...
(deftest postgresql-test-with-query-cursor-data-order
...
(deftest postgresql-test-with-query-cursor-no-duplicates
...
(deftest postgresql-test-show-query-sql-with-query
